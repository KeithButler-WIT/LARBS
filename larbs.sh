...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/keithbutler-wit/voidrice.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/keithbutler-wit/LARBS/master/progs.csv"
